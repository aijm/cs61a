...
class Player(object):
    ...
    def go_to(self, location):
        ...
        if destination_place.locked:
            ...
            now_placename = destination_place.name
            self.place = destination_place
        print('You are at {}'.format(now_placename))
        "*** YOUR CODE HERE ***"
    ...
    def unlock(self, place):
        ...
        if destination_place is self.place:
            return
        elif destination_place.locked == False:
